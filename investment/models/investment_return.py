...
class InvestmentReturn(BaseModel):
    ...
    property = models.ForeignKey(Property, on_delete=models.DO_NOTHING, null=True, blank=True, related_name="property_returns")
    return_in_amount = models.FloatField(null=True)
    return_type = models.CharField(max_length=255, null=True, choices=RETURN_TYPE_CHOICES, default="RENTAL")
